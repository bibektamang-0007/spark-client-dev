...
export const AuthLayoutv2 = () => {
  return (
    <section className="min-h-screen w-full relative overflow-hidden bg-[#fafafa] flex items-center justify-center">
      ...
      <div className="relative container mx-auto grid grid-cols-1 items-center justify-center gap-14 lg:grid-cols-2 lg:gap-20 px-6 max-w-7xl z-10 py-12">
        <motion.div
